...
<template>
    <div class="container exportButton">
            <div>
                <div class="row mb-5">
                    <div class="col">
                        <div class="col ">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-footer">
            ...
            <div class="row">
                <button type="button" class="btn btn-primary export-option mb-1" @click="exportData('all')">Everything (.csv)</button>
                <button type="button" class="btn btn-primary export-option mb-1" @click="exportData('simple')">Simplified (.csv)</button>
                <button type="button" class="btn btn-primary export-option mb-1" @click="exportData('pgn')">PGN (.pgn)</button>
                <button type="button" class="btn btn-primary export-option mb-1" @click="exportData('json')">JSON (.json)</button>
                <button type="button" id="custom-export-btn" data-bs-toggle="modal" data-bs-target="#custom-export-modal" class="btn btn-primary export-option mb-1" @click="viewCustomExport()">Custom</button>
    ...
    <div class="modal fade" id="custom-export-modal" tabindex="-1" aria-labelledby="custom export modal" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-footer">
            <div class="row">
                    <button type="button" class="btn btn-primary export-option mb-1" @click="customExport()">Export</button>
            </div>
...
<script>
import { exportChessData, makeCustomExport, showCustomExport } from '../scripts/exportUtils.js'

export default {
    name: "ExportData",
    methods: {
        exportData(option) {
            exportChessData(option);
        },
        viewCustomExport(){
            showCustomExport();
        },
